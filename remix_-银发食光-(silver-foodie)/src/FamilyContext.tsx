...
import { AppState, FamilyGroup, FamilyMember, SharedContent, HealthProfile, GameScore } from './types';
...
export function FamilyProvider({ children }: { children: ReactNode }) {
  ...
  }, [sharedItems, familyGroup, favoriteIds, gameScores, learnedKnowledgeIds]);
