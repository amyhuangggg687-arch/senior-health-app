...
export default function SeniorNotifications() {
  ...
  return (
    <div className="min-h-screen bg-vintage-texture pb-24">
      <header className="bg-white/60 backdrop-blur-xl px-6 py-5 shadow-sm border-b border-white/20">
        <h1 className="text-2xl font-hand font-bold text-vintage-brown flex items-center gap-3">
              ...
              return (
                ...
                >
                  ...
                  <div className="bg-white/40 p-6 rounded-2xl mb-8 border-2 border-vintage-brown/5">
                    ...
                    {item.message && (
                      <p className="text-sm font-hand text-vintage-brown/40 mb-2">我之前问：{item.message}</p>
                    )}
                    
                    <div className="bg-vintage-cream/60 p-4 rounded-xl mb-3 border-l-4 border-vintage-orange italic font-retro text-lg text-vintage-brown/80 leading-relaxed shadow-inner">
                      “{analysis.healthReason}”
                    </div>

                    {item.reply && (
                      <div className="bg-blue-50/50 p-4 rounded-xl mb-6 border-l-4 border-blue-400 italic font-hand text-xl text-zinc-600 leading-relaxed">
                        叮嘱：{item.reply}
                      </div>
                    )}
