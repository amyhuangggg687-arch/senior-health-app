    ...
    <div className="relative h-screen w-full bg-vintage-texture flex flex-col overflow-hidden p-3" ref={containerRef}>
      ...
      <AnimatePresence mode="popLayout" custom={direction}>
        <motion.div 
          ...
          animate="animate"
          exit="exit"
          className="relative flex-1 flex flex-col bg-white p-3 shadow-[0_12px_50px_rgba(0,0,0,0.2)] rounded-sm border-[6px] border-zinc-50 overflow-hidden h-full"
        >
          {/* Main Content Area */}
          <div className="relative flex-1 bg-zinc-900 overflow-hidden rounded-sm group shadow-inner flex flex-col h-full">
            <img 
            ...
            <div className="absolute right-3 bottom-24 flex flex-col gap-6 items-center z-20">
              ...
              <button className="flex flex-col items-center gap-1 group">
                <div className="w-12 h-12 rounded-full bg-black/30 backdrop-blur-md flex items-center justify-center group-active:scale-90 transition-transform">
                  <Heart className="w-7 h-7 text-white fill-none group-hover:text-red-500 group-hover:fill-red-500" />
                </div>
                <span className="text-white text-xs font-bold drop-shadow-md">{currentVideo.likes}</span>
              </button>
              ...
              <button className="flex flex-col items-center gap-1 group">
                ...
                <span className="text-white text-xs font-bold drop-shadow-md">留言</span>
              </button>
              ...
              >
                <div className="w-12 h-12 rounded-full bg-black/30 backdrop-blur-md flex items-center justify-center group-active:scale-90 transition-transform">
                  <Star className={cn("w-7 h-7", isFavorited ? "text-vintage-yellow fill-vintage-yellow" : "text-white")} />
                </div>
                <span className={cn("text-white text-xs font-bold drop-shadow-md", isFavorited && "text-vintage-yellow")}>
                  {isFavorited ? '已收' : '收藏'}
                </span>
              </button>
              ...
              <button 
                ...
                className="flex flex-col items-center gap-1 group"
              >
                <div className="w-14 h-14 bg-vintage-orange rounded-full shadow-xl border-2 border-white group-hover:rotate-12 transition-all flex items-center justify-center">
                  <Share2 className="w-8 h-8 text-white" />
                </div>
                <span className="text-white text-xs font-bold drop-shadow-md mt-1">寄回家</span>
              </button>
            </div>
