...
function Navigation() {
  ...
  return (
    <nav className={cn(
      "fixed bottom-0 left-0 right-0 px-4 py-2 flex justify-around items-center z-50 border-t-2 bg-white/95 backdrop-blur-md border-vintage-brown/5 shadow-[0_-2px_10px_rgba(0,0,0,0.05)]"
    )}>
      {isSenior ? (
        <>
          <Link 
